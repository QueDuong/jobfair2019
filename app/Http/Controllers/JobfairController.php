       ...
       public function sendEmail( $email)
       {
        ...
        ->where("candidates.email","=", $email)
         ...
         $pwd=$canidate_mail->pwd;
                $message = "Dear {{$name}} <br><br> Cảm ơn bạn đã đăng kí tham gia SEKISHO JOB FAIR.<br><br>Dưới đây sẽ là mã số đăng ký của bạn tại JOB FAIR lần này:<br>Your entry number:<strong>  {{$id}}</strong><br>Password:<strong>  {{$pwd}}</strong><br><br> Hãy sử dụng mã số này để đăng ký vào hội trường tại quầy lễ tân.<br><br> Để thay đổi thông tin đăng kí bạn vui lòng sử dụng mã số đăng ký và mật khẩu trên để đăng nhập vào đường link dưới đây: 
    <br><br>Link: http://srv1.sekisho-vn.com/jobfair2019/joblogined<br><br> Hẹn gặp lại bạn tại buổi JOBFAIR vào ngày 02~03/11/2019 tới đây tại Thư viện Tạ Quang Bửu - Đại học Bách Khoa Hà Nội nhé.";
         ...
         public function sendEmail2( $email)
       {
        ...
        ->where("candidates.email","=", $email)
         ...
         $id=$canidate_mail->id;
         $pwd=$canidate_mail->pwd;
               $message = " Dear {{$name}} <br><br> Thông tin của bạn đã được cập nhật..<br><br>Hẹn gặp bạn ở SEKISHO JOB FAIR diễn ra tại Thư viện Tạ Quang Bửu - Đại học Bách khoa Hà Nội vào ngày 02~03/11/2019. " ;
        $body = "<html>\n";
        $body .= "<head>\n";
        $body .= "<meta charset='UTF-8' />\n</head>";
          $body .= "<body>\n"; 
