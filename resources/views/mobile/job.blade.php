...
<div class="container" style="background: #c6dedb" >
  <form method="post" action="{{url('jobfair')}}" autocomplete="off">
      ...
      <div class="form-class row" style="margin-bottom: 6px;">
        <div class="control-label col-xs-12 col-sm-12">
        </div>
  ...
  {{csrf_field()}}
      ...
      <div class="form-class row">
        <label class="control-label col-xs-12 col-sm-12">HỌ TÊN<span class="error">*</span></label>
        ...
        <label class="control-label col-xs-12 col-sm-12">GIỚI TÍNH<span class="error">*</span></label>
        <div class="col-sm-12 col-xs-12">
      ...
      <div class="form-class row">
	  <br>
        <label class="control-label col-xs-12 col-sm-12">EMAIL<span class="error">*</span></label>
        <div class="col-sm-12 col-xs-12">
        ...
        <label class="control-label col-xs-12 col-sm-12">SỐ ĐIỆN THOẠI<span class="error">*</span></label>
      ...
      <div class="form-class row">
           {{csrf_field()}}
        <label class="control-label col-xs-12 col-sm-12">NGÀY SINH<span class="error">*</span></label>
        <div class="col-sm-12 col-xs-12">
          <input type="date" name="birthday"  value="dd-mm-yyyy" min="01-01-1980" max="31-12-2001" class="form-control" required/>
          
          <br>
        </div>
         </div>
         <div class="form-class row">
        <label class="control-label col-xs-12 col-sm-12" style="padding-top: 0px">ĐỊA ĐIỂM LÀM VIỆC<br> MONG MUỐN<span class="error">*</span></label>
        <div class="col-sm-2">
      ...
      <div class="form-class row" style="margin-bottom: 20px;">
        <label class="control-label col-xs-12 col-sm-12">QUÊ QUÁN<span class="error">*</span></label>
        <div class="col-sm-12 col-xs-12">
           ...
           style="width: 130px; height: 28px; float: left">
            ...
            ?>
             <option value="264" >Other</option>
              ...
              <input type="text" class="form-control" name="other_birthplace" placeholder="Quê quán" id="other-birthplace" style='width: 128px; margin-left: 135px; display:<?php  if ($birth_place=="264") {echo "block";} else {echo "none";}?>; height: 28px;' >
         
        </div>
          
        </div>
       <div class="form-class row" style="margin-bottom: 20px;">
        <label class="control-label col-xs-12 col-sm-12">ĐỊA CHỈ HIỆN TẠI<span class="error">*</span></label>
        <div class="col-sm-2">
          <select name='address' required 
          onchange='CheckOtherQ(this.value, "other-address","264")'
            style="width: 130px; height: 28px;">
           <option selected="selected" value="" ><span style="color: #d2c8c8">--------</span>
           </option>
            <?php 
      ...
      <div class="form-class row" style="margin-top: 20px; margin-bottom: 20px">
        <label class="control-label col-xs-12 col-sm-12">TRƯỜNG ĐẠI HỌC<span class="error">*</span></label>
        <div class="col-sm-4">
        ...
        <div class="col-sm-2" style="width: 190px">
          <input type="text" placeholder="Tên trường đại học" class="form-control" name="other_university" id="other-university" style='display:<?php if ($university=="8000") {echo "block";} else {echo "none";}?>; height: 28px;' >   
        </div>
      </div>

      <div class="form-class row">
        <label class="control-label col-xs-12 col-sm-12">CHUYÊN NGÀNH<span class="error">*</span></label>
        <div class="col-sm-12 col-xs-12">
          <input type="text" name="department" placeholder="Chuyên ngành học"  value="{{ old('department')}}"  class="form-control" required/>
         
        </div>

        <label class="control-label col-xs-12 col-sm-12" style="padding-top: 0px">TRÌNH ĐỘ TIẾNG ANH (TOEIC)
 ...
 <div class="form-class row">
          <label class="control-label col-xs-12 col-sm-12" style="padding-top: 0px">TRÌNH ĐỘ TIẾNG NHẬT (JLPT)<span class="error">*</span></label>
        <div class="col-sm-2">
      ...
      <div class="form-class row" style="margin-bottom: 10px; margin-top: 20px">
        ...
        <label class="control-label col-xs-12 col-sm-12"style="padding-top: 0px">THỜI GIAN <br> TỐT NGHIỆP<span class="error">*</span></label>
        <div class="col-sm-12 col-xs-12">
      ...
      <div class="form-class row">
        <label class="control-label col-xs-12 col-sm-12">CÁC KỸ NĂNG KHÁC</label>
        <div class="col-sm-12 col-xs-12">
        ...
        <label class="control-label col-xs-12 col-sm-12">PR BẢN THÂN</label>
        <div class="col-sm-12 col-xs-12">
   ...
   <div class="form-class row">
        <label class="control-label col-xs-12 col-sm-12">LINK FACEBOOK CỦA BẠN</label>
        <div class="col-sm-12 col-xs-12">
      ...
      <div class="form-class row" style="margin-top: 10px">
            <label class="control-label col-xs-12 col-sm-12">Lĩnh vực IT </label>
      ...
      <div class="form-class row" style="margin-top: 10px">     
        <label class="control-label col-xs-12 col-sm-12">Lĩnh vực kỹ thuật</label>
        <div class="col-sm-10">
          <div class="row">
            <?php 
      ...
      <div class="form-class row" style="margin-top: 10px">     
        <label class="control-label col-xs-12 col-sm-12">Lĩnh vực nghiên cứu</label>
        <div class="col-sm-10">
          <div class="row">
         <?php 
              foreach($subitemsIT as $copor){
      ...
      <div class="form-class row" style="margin-top: 10px">     
        <label class="control-label col-xs-12 col-sm-12">Lĩnh vực tài chính, bảo hiểm</label>
        <div class="col-sm-10">
          <div class="row">
         <?php 
              foreach($subitemsIT as $copor){
      ...
      <div class="form-class row" style="margin-top: 10px">     
        <label class="control-label col-xs-12 col-sm-12">Lĩnh vực khác </label>
        <div class="col-sm-10">
          <div class="row">
            <?php 
      ...
      <div class="form-class row" style="margin-top: 10px">
        <label class="control-label col-xs-12 col-sm-12"</span></label>
        <div class="col-sm-10">
          <div class="row">
        ...
        <div>
            ...
            <div class="col-sm-offset-3 col-sm-6" style="margin-top: 20px">
                 <div class="g-recaptcha" data-sitekey="6LfDN3EUAAAAADBe6cZ68llmz0uPRVuzP01zjGqA" data-callback="enableBtn" style="margin-top: 20px;margin-bottom: : 20px"></div>
