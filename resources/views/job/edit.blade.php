...
<div class="container" style="background: #c6dedb" >
    <!-- <form method="post" action="{{url('register2018')}}"> -->
   
<form method="GET" action="{{ url('updatetJob') }}">
    ...
    @endif
      ...
      <div class="form-class row">
        ...
        <div class="col-sm-3">
           {{csrf_field()}}
          <input type="text" placeholder="Họ tên" name="name" value="{{$eidtCandidate ->name}}"
          class="form-control
          input-text" required/>
        ...
        <div class="col-sm-3">
          ...
          <div class="radio-inline">
            ...
            <?php if ( $eidtCandidate->sex=="male") echo "checked";?>
            value="male">Nam
          </div>
             <div class="radio-inline">
            <input type="radio" name="sex"
            <?php if ( $eidtCandidate->sex=="female") echo "checked";?>
            value="female">Nữ 
          </div>
        </div>
      </div>
      ...
      <div class="form-class row">
        ...
        <div class="col-sm-3">
          <input type="email" placeholder="Email" name="email" value="{{$eidtCandidate ->email}}" class="form-control input-text" id="email" required/>
        ...
        <div class="col-sm-3" style="width: 190px">
          <input type="text" placeholder="Số điện thoại" name="tel" value="{{ $eidtCandidate ->tel}}" class="form-control" id="tel" onkeypress='return event.charCode >= 48 && event.charCode <= 57' required/>
          <br>
        </div>
      ...
      <div class="form-class row">
        ...
        <div class="col-sm-3">
          <input type="date" name="birthday"  value="1995-01-01" min="1980-01-01" max="2000-12-31" class="form-control" required/>
        ...
        <div class="col-sm-2">
          <select name='workplace' required style="width: 159px; height: 28px;">
              <option value="{{$eidtCandidate->work_place_id}}">{{$eidtCandidate->wpName}}</option>
            <?php 
              
             
               foreach($work_places as $workPlace){
               if($workPlace->code =='1')
                 {
                echo "<option value='".$workPlace->id."'";
                 if( $workPlace->id  == old('workplace') ) echo " selected='selected'  ";
                echo ">".$workPlace->name."</option>";
      ...
      <div class="form-class row" style="margin-bottom: 20px;">
        ...
        <div class="col-sm-3">
          <select name='birthplaces' required  style="width: 130px; height: 28px; float: left">
              <option value="{{$eidtCandidate->birth_place_id}}">{{$eidtCandidate->birthName}}</option>
            <?php 
          ...
          <input type="text" class="form-control" name="other_birthplace" placeholder="Quê quán" id="other-birthplace" style='width: 128px; margin-left: 135px; display:<?php  if ($birth_place=="100") {echo "block";} else {echo "none";}?>; height: 28px;' value="<?php echo $other_birthplace; ?>">
         
        </div>
      
        <label class="control-label col-sm-2">ĐỊA CHỈ HIỆN TẠI<span class="error">*</span></label>
        <div class="col-sm-2">
          <select name='address' required   style="width: 160px; height: 28px;">
            <option value="{{$eidtCandidate->address_id}}">{{$eidtCandidate->addName}}</option>
            <?php 
        ...
        <div class="col-sm-2">
          <input type="text" class="form-control" placeholder="Nơi đang sinh sống" name="other_address" id="other-address" style='display:<?php if ($address=="100") {echo "block";} else {echo "none";}?>; height: 28px;' value="<?php echo $other_address; ?>">
      ...
      <div class="form-class row" style="margin-top: 20px; margin-bottom: 20px">
        ...
        <div class="col-sm-4">
          <select name='university' required onchange='CheckOther(this.value, "other-university");' style="width: 260px; height: 28px;">
                   <option value="{{$eidtCandidate->university_id}}">{{$eidtCandidate->uniName}}</option>
            <?php 
        ...
        <div class="col-sm-2" style="width: 190px">
          <input type="text" placeholder="Tên trường đại học" class="form-control" name="other_university" id="other-university" style='display:<?php if ($university=="100") {echo "block";} else {echo "none";}?>; height: 28px;' value="<?php echo $other_university; ?>">   
        </div>
      </div>
      ...
      <div class="form-class row">
        ...
        <div class="col-sm-3">
          <input type="text" name="department" placeholder="Chuyên ngành học"  value="{{ $eidtCandidate->department}}"  class="form-control" required/>
        ...
        <div class="col-sm-2">
          <select name='english' required style="width: 159px; height: 28px;">
                   <option value="{{$eidtCandidate->english_level_id}}">{{$eidtCandidate->eName}}</option>
            <?php 
      ...
      <div class="form-class row" style="margin-bottom: 10px; margin-top: 20px">
        ...
        <div class="col-sm-2">
          <select name='japanese' required style="height: 28px; width: 160px">
            <option value="{{$eidtCandidate->japanese_level_id}}">{{$eidtCandidate->jName}}</option>
            <?php 
      ...
      <div class="form-class row">
        <label class="control-label col-sm-2">CÁC CHỨNG CHỈ KHÁC</label>
        <div class="col-sm-3">
          <textarea name="other_certification"  style="resize:none"  placeholder="VD CAD, IT..." 
              class="form-control" >{{$eidtCandidate->other_certification}}</textarea>
        </div>
        ...
        <div class="col-sm-3">
          <textarea name="selfPR"  style="resize:none"  placeholder="VD Đã từng đi Nhật." 
           class="form-control" >{{ $eidtCandidate->selfPR }}</textarea>
        </div>
      </div>
      ...
      <div class="form-class row" style="margin-top: 10px">
            ...
            <?php 
              ...
              if(in_array($copor->name, $items_cop ))  echo "checked";
                echo "> ".$copor->name."</div>";                
              }
            ?>
      ...
      <div class="form-class row" style="margin-top: 10px">
          ...
          <div class="row">
            ...
            <?php 
              foreach($subitemsIT as $copor){
                 if($copor->code =='1'){
                echo "<div class='col-sm-4'><input type='checkbox' name='itemsIT_select[]' value='".$copor->name."'";
                if(in_array($copor->name, $itemsIT_select2 ) )  echo "checked";
                echo "> ".$copor->name."</div>";
              }
              }
            ?>
        ...
        value="{{ $eidtCandidate->otherIT}}"   class="form-control" name="other_subIT" id="other_subIT" >    
        </div>
      ...
      <div class="form-class row" style="margin-top: 10px">     
          ...
          <div class="row">
            <?php 
              foreach($subitemsTech as $copor){
                 if($copor->code =='2'){
                echo "<div class='col-sm-4'><input type='checkbox' name='itemsTech_select[]' value='".$copor->name."'";
                  if(in_array($copor->name, $itemsTech_select2))  echo "checked";
                echo "> ".$copor->name."</div>";
              }
            }
            ?>  
        ...
        <div class="row-col-sm-4" style="width: 260px;margin-left: 10px">
         ...
         value="{{ $eidtCandidate->otherTech}}"  class="form-control" name="other_subTech" id="other_subTech" >
          </div>
      </div>
    </div>
      ...
      <div class="form-class row" style="margin-top: 10px">     
        ...
        <div class="col-sm-10">
          <div class="row">
            <?php 
              foreach($subitemsLab as $copor){
                 if($copor->code =='3'){
                echo "<div class='col-sm-4'><input type='checkbox' name='subitemsLab_select[]' value='".$copor->name."'";
                if(in_array($copor->name, $subitemsLab_select2))  echo "checked";
                echo "> ".$copor->name."</div>";
              }
            }
            ?>
          ...
          <input type="text" placeholder="Lĩnh vực nghiên cứu khác" 
           value="{{ $eidtCandidate->otherLab}}"  class="form-control" name="other_subLab" id="other_subLab" >
          </div>
      ...
      <div class="col-sm-2" style="text-align: right;">   
        <label class="control-label" >Lĩnh vực tài chính,</label>
        <br>
        ...
        <div class="col-sm-10">
          ...
          <div class="row">
            <?php 
              foreach($subitemsFin as $copor){
                 if($copor->code =='4'){
                echo "<div class='col-sm-4'><input type='checkbox' name='subitemsFin_select[]' value='".$copor->name."'";
             if(in_array($copor->name, $subitemsFin_select2))  echo "checked";
                echo "> ".$copor->name."</div>";
              }
            }
            ?>
          ...
          <div class="row-col-sm-4" style="width: 260px;margin-left: 10px">
          <input type="text" placeholder="Lĩnh vực Tài Chính Khác" class="form-control"
             value="{{ old('other_subFin')}}"  name="other_subFin" id="other_subFin" >
          </div>
      ...
      <div class="form-class row" style="margin-top: 10px">     
        <label class="control-label col-sm-2">Lĩnh vực nhân văn </label>
        <div class="col-sm-10">
          <div class="row">
            <?php 
              foreach($subitemsOther as $copor){
                 if($copor->code =='5'){
                echo "<div class='col-sm-4'><input type='checkbox' name='subitemsOther_select[]' value='".$copor->name."'";
               if(in_array($copor->name,$subitemsOther_select2))  echo "checked";
                echo "> ".$copor->name."</div>";
              }
            }
            ?>
          ...
          <div class="row-col-sm-4" style="width: 260px;margin-left: 10px">
          <input type="text" placeholder="Lĩnh vực nhân văn khác" class="form-control" 
