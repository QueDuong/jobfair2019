<html>
  ...
  <body>
 <form method="GET" action="{{ url('editJob') }}">
    <input name="_method" type="hidden" value="PATCH">
      ...
      <div class="alert alert-danger">
        <strong>Sai id hoặc mật khẩu!</strong> 
      </div>
    @endif
  {{csrf_field()}}
        ...
        <?php endif; ?>
          ...
          <div class="form-group">
            <div class="col-sm-10">
                <input style="border-radius: 3px" type="text" placeholder="Enter entry number" name="entry_no" required>
        ...
        <br>
        <a href="jobfair" style="margin-left: 110px">Quay lại trang chủ</a>
        </div>
    </form>
  </body>
</html>